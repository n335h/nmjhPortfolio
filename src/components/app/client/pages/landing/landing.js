			...
			<div className='mx-auto max-w-full-xl px-4 py-32 lg:flex lg:h-screen lg:items-center'>
				<div className='mx-auto max-w-xl text-center'>
					...
					<div className='mt-2 flex flex-wrap justify-center gap-4'>
						...
						<a
							href='#contact'
							className='mt-4 border border-2 inline-block rounded-full  border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white dark:border-indigo-600 dark:hover:bg-indigo-600 dark:hover:text-gray-300  focus:outline-none focus:ring active:bg-indigo-500'>
							contact
						</a>
					</div>
				</div>
