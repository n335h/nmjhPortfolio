		...
		<section
			...
			<div className='mx-auto max-w-full-xl px-4 py-32 lg:flex lg:h-screen lg:items-center'>
				<div className='mx-auto max-w-xl text-center'>
					<h1 className='text-3xl text-zinc-600 dark:text-zinc-300 font-extrabold sm:text-5xl'>
						Nicholas Horishny
						<h2 className='font-bold text-indigo-700 text-2xl sm:block'>
					...
					<div className='mt-2 flex flex-wrap justify-center gap-4'>
						...
						<a
							href='#contact'
							className='mt-4 border border-4 inline-block rounded-full  border-indigo-600 px-12 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white dark:border-indigo-600 dark:hover:bg-indigo-600 dark:hover:text-gray-300  focus:outline-none focus:ring active:bg-indigo-500'>
							contact
						</a>
					</div>
				</div>
